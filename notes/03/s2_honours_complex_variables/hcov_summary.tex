...
\end{align*}
The \textcolor{red}
{principle argument of $z$} is defined as
...
on a neighbourhood of $(x_0,y_0)$.
Then $f$ is differentiable at $z_0$.

\subsubsection*{Remark}
For $f$ to be differentiable we need to check
T1.4.8 and the contrapositive of T1.4.6.
...
and is discontinuous on the negative real axis
...
Also $\text{Log}_{\phi}\bigl[g(z)\bigr]$ is holomorphic on 
all points $z\in g^{-1}(D_{0,\phi})$.
